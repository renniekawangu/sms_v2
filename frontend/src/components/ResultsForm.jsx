      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-text-dark mb-2">Exam *</label>
              <select
                value={formData.exam}
            ...
            <div>
              <label className="block text-sm font-medium text-text-dark mb-2">Student *</label>
              <select
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-text-dark">Subject Results</h3>
              <button
                type="button"
                onClick={handleAddSubject}
                className="flex items-center gap-2 px-3 py-1.5 bg-primary-blue text-white rounded-lg hover:bg-primary-blue/90 transition-colors text-sm"
              >
                <Plus size={16} />
                Add Subject
              </button>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-lg font-semibold text-text-dark">{formData.totalScore}</p>
              </div>
              <div>
                <p className="text-sm text-text-muted">Total Max Marks</p>
                <p className="text-lg font-semibold text-text-dark">{formData.totalMaxMarks}</p>
              </div>
              <div>
          ...
          <div className="flex gap-3 justify-end pt-6 border-t">
            <button
              type="button"
              onClick={() => onClose(false)}
              className="px-4 py-2 border border-gray-200 rounded-lg text-text-dark hover:bg-gray-50 transition-colors font-medium"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-primary-blue text-white rounded-lg hover:bg-primary-blue/90 transition-colors font-medium disabled:opacity-50"
            >
