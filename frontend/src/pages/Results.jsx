  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-text-dark">Results</h1>
          <p className="text-text-muted mt-1">Manage exam results</p>
        </div>
        ...
        {results.length > 0 && (
          <div className="mb-6">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search results by exam, subject, or marks..."
                value={searchQuery}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 px-4 text-sm font-semibold text-text-dark">Exam</th>
                <th className="text-left py-3 px-4 text-sm font-semibold text-text-dark">Subject</th>
                <th className="text-left py-3 px-4 text-sm font-semibold text-text-dark">Marks</th>
                {user?.role !== 'student' && (
            ...
            <tbody>
              {filteredResults.length === 0 ? (
                <tr>
                  <td colSpan={user?.role !== 'student' ? 4 : 3} className="py-8 text-center text-text-muted">
